...
class FilesController {
  ...
  static async postUpload(request, response) {
    ...
    // if not folder, store file in DB unscrambled
      ...
      // Creates an ID and a new path to the new file
      const filenameUUID = uuidv4();
      const localPath = `${folderPath}/${filenameUUID}`;

      // Unscrambles data and writes to new path
    ...
    // Returns the new file with a status code 201
  ...
  // GET /files
  // Returns the files attached to the user
